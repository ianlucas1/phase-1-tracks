...
describe Otter do
  ...
  describe "experience and levling up" do
    ...
    it "initializes to normal status" do
      expect(mascot.status).to eq :normal
    end

    it "can change status to raging" do
      mascot.rage
      expect(mascot.status).to eq :raging
    end

    it "can change status to normal" do
      mascot.reset_status
      expect(mascot.status).to eq :normal
    end

    it "can change status to levitating" do
      mascot.levitate
      expect(mascot.status).to eq :levitating
    end
